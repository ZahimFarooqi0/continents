...
export default function Papuanewguinea(){
    const obj={
        population: 8600000,
    ...
    return(
        <div className="flex flex-col items-center justify-center mt-10"> 
          ...
          <h1 className="text-4xl font-bold text-center mb-8">PAPUA NEW GUINEA</h1>
          ...
          ><Link href="/continents/oceania">GO BACK TO COUNTRIES</Link></button>
            </div> 
        </div>
    )
}